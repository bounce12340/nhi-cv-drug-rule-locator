...
## 6. RA 決定點(已裁,2026-08-05:同 PR #33 驗收語式)

- **H4 照案**:以初評「非屬 SaMD」為**工作假設**續行 M2 文件與設計;送審/production 前取得正式法律意見(v3.2 §32)
- **H5 照案**:P1–P3 起手(Fable 直寫,分批 PR 供 PASS;P1 隱私文件草案先行)
- **H6 照案**:M2 全文件側=Fable 直寫;實作建置=Phase 2 屆時另立 TC+閘門

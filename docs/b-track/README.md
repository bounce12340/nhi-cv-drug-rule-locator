...
> **2026-08-09 裁示(B3 審查範圍)**:派發方提報建議——B3 現行範圍僅涵蓋 Phase 2 之 auth/帳號資料面(尚未實作之系統),而依 RDL-018 已上線之 web-only、無帳號 production 系統從未經資安審查;建議同次委任擴充涵蓋現行線上系統。**RA 裁示「不加現行線上系統」**,B3 範圍維持原樣。
>
> 據此,現行線上系統之未經資安審查狀態**延續 RDL-018 已登記之偏離**(RA 明示承擔風險),非新增風險亦非新增豁免;本裁示僅確認不於 B3 委任中一併處理。日後如變更,於本節追記。

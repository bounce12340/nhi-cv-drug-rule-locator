...
調價品項顯示公告所載的**原支付價 → 初核價格**對照;所有品項都可展開完整價格沿革(全主檔共 4,048 個價格區間)。查詢日期可調整,價格依該日期適用的區間顯示,不會回退到最近期。
...
| `nhi-lipid-rules-structured-2026-09-01-r1` | 藥品給付規定 2.6.1–2.6.3(2026-09-01 生效),67 個逐字單元 |
